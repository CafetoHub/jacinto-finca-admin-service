...
@RestController
@RequestMapping("/api/jacinto-finca-admin-service-kafka")
public class JacintoFincaAdminServiceKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JacintoFincaAdminServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JacintoFincaAdminServiceKafkaResource(KafkaProperties kafkaProperties) {
