...
import com.jacinto.fas.repository.OwnerRepository;
import com.jacinto.fas.service.OwnerService;
import com.jacinto.fas.service.dto.OwnerDTO;
import com.jacinto.fas.service.mapper.OwnerMapper;
...
public class OwnerResourceIT {
    ...
    public void createOwner() throws Exception {
        ...
        assertThat(testOwner.getCedula()).isEqualTo(DEFAULT_CEDULA);
    }
    ...
    public void updateOwner() throws Exception {
        ...
        Owner testOwner = ownerList.get(ownerList.size() - 1);
        assertThat(testOwner.getCedula()).isEqualTo(UPDATED_CEDULA);
    }
